...
void MultiPurposeLayer::createLayout2()
{
    ...
    totalWidth = fbButton->getContentSize().width;
#elif CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
    // The Android port focuses on local gameplay, so omit legacy social login buttons.
#endif

    if (buttonsNode->getChildrenCount() > 0)
