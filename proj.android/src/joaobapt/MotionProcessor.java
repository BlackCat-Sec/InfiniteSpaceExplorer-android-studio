...
public class MotionProcessor implements SensorEventListener
{
	...
	native static void manualSensorFusionFeedGyroscopeData(float[] gyroData, long timestamp, ByteBuffer buffer);
		...
		else
		{
			...
			switch(event.sensor.getType())
			{
				...
				case Sensor.TYPE_GYROSCOPE:
					manualSensorFusionFeedGyroscopeData(event.values, event.timestamp, manualSensorFusionBuffer);
					break;
